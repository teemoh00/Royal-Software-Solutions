        ...
        <footer className="footer">
            <div className="container footer-container">
                ...
                <div className={`footer-col accordion-col ${openMenus.services ? 'open' : ''}`}>
                    ...
                    <ul className="footer-links accordion-content">
                        ...
                        <li><Link to="/products-services">Fahari Nexus</Link></li>
                ...
                <div className="footer-col contact-col">
                    ...
                    <ul className="contact-info">
                        ...
                        <li><Phone size={16} /> 0101031075</li>
            ...
            <div className="footer-bottom container">
                ...
                <div className="social-links">
                    ...
                    <a href="https://wa.me/254759437978?text=Hi%2C%20I%27d%20like%20to%20learn%20more%20about%20your%20software%20solutions." target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
